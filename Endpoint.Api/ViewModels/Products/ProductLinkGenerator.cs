...
public static class ProductLinkGenerator
{
    ...
    public static ProductViewModel AddLinks(this ProductViewModel viewModel)
    {
        ...
        {
            new(ProductUrl,"update_product",HttpMethod.Put.Method),
            new($"{ProductUrl}/{viewModel.Id}","delete_product",HttpMethod.Delete.Method),
        };
    ...
    public static List<ProductViewModel> AddLinks(this List<ProductViewModel> viewModel)
    {
        ...
        viewModel.ForEach(item =>
        {
            ...
            {
                new(ProductUrl,"update_product",HttpMethod.Put.Method),
                new($"{ProductUrl}/{item.Id}","delete_product",HttpMethod.Delete.Method),
                new($"{ProductUrl}/{item.Id}","self",HttpMethod.Get.Method),
            };
